...
class LifePolicyFragment : BasePolicyCategoryFragment<FragmentBasePolicyCategoryBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = LifePolicyFragment()
    }
    ...
    val viewModel by viewModels<LifePolicyViewModel>{ LifePolicyViewModelFactory(this) }
