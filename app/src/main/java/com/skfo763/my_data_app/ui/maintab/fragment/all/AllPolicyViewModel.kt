...
class AllPolicyViewModel(private val view: IBasePolicyView) : BasePolicyCategoryViewModel(view) {
    override val tempRecyclerItemList: MutableList<PolicyListItem> = mutableListOf(
        PolicyHeader("전체", "김OO님이 지원 가능한 정책은", 25, view.headerBackgroundDrawable),
