package com.skfo763.my_data_app.ui.maintab.fragment.Entrepreneur
...
import com.skfo763.my_data_app.ui.maintab.fragment.entreperner.EntrepreneurPolicyViewModel
import com.skfo763.my_data_app.ui.maintab.fragment.entreperner.EntrepreneurPolicyViewModelFactory

class EntrepreneurPolicyFragment : BasePolicyCategoryFragment<FragmentBasePolicyCategoryBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = EntrepreneurPolicyFragment()
    }
    ...
    val viewModel by viewModels<EntrepreneurPolicyViewModel>{ EntrepreneurPolicyViewModelFactory(this) }
