...
class JobPolicyFragment : BasePolicyCategoryFragment<FragmentBasePolicyCategoryBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = JobPolicyFragment()
    }
    ...
    val viewModel by viewModels<JobPolicyViewModel>{ JobPolicyViewModelFactory(this) }
