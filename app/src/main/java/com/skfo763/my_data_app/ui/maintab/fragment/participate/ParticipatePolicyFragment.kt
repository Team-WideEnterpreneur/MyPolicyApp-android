...
class ParticipatePolicyFragment : BasePolicyCategoryFragment<FragmentBasePolicyCategoryBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = ParticipatePolicyFragment()
    }
    ...
    val viewModel by viewModels<ParticipatePolicyViewModel>{ ParticipatePolicyViewModelFactory(this) }
