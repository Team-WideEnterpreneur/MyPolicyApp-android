...
class Covid19PolicyFragment : BasePolicyCategoryFragment<FragmentBasePolicyCategoryBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = Covid19PolicyFragment()
    }
    ...
    val viewModel by viewModels<Covid19PolicyViewModel>{ Covid19PolicyViewModelFactory(this) }
